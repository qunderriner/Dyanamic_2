...
export declare class CoreNormalizer extends SpecMapper<NormalizerParams, FacetedUnitSpec, ExtendedLayerSpec> {
    ...
    map(spec: GenericSpec<FacetedUnitSpec, ExtendedLayerSpec>, params: NormalizerParams): NormalizedUnitSpec | GenericLayerSpec<NormalizedUnitSpec> | NormalizedFacetSpec | GenericRepeatSpec<NormalizedUnitSpec, GenericLayerSpec<NormalizedUnitSpec>> | import("../spec/concat").GenericConcatSpec<NormalizedUnitSpec, GenericLayerSpec<NormalizedUnitSpec>> | import("../spec").GenericVConcatSpec<NormalizedUnitSpec, GenericLayerSpec<NormalizedUnitSpec>> | import("../spec").GenericHConcatSpec<NormalizedUnitSpec, GenericLayerSpec<NormalizedUnitSpec>>;
