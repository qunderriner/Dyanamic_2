...
export declare function getDefaultValue(property: keyof Scale, model: Model, channel: Channel, fieldDef: ScaleFieldDef<string, Type>, scaleType: ScaleType, scalePadding: number | SignalRef, scalePaddingInner: number | SignalRef, specifiedDomain: Scale['domain'], markDef: MarkDef, config: Config): any;
...
export declare function nice(scaleType: ScaleType, channel: Channel, fieldDef: TypedFieldDef<string>): boolean | TimeInterval;
export declare function padding(channel: Channel, scaleType: ScaleType, scaleConfig: ScaleConfig, fieldDef: TypedFieldDef<string>, markDef: MarkDef, barConfig: RectConfig): number | SignalRef;
