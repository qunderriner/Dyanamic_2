...
export function parseLegendForChannel(model, channel) {
    ...
    const legendEncoding = (_a = legend.encoding) !== null && _a !== void 0 ? _a : {};
    ...
    const legendEncode = ['labels', 'legend', 'title', 'symbols', 'gradient', 'entries'].reduce((e, part) => {
        ...
        if (value !== undefined && keys(value).length > 0) {
            e[part] = Object.assign(Object.assign(Object.assign({}, ((selections === null || selections === void 0 ? void 0 : selections.length) ? { name: `${varName(fieldDef.field)}_legend_${part}` } : {})), ((selections === null || selections === void 0 ? void 0 : selections.length) ? { interactive: !!selections } : {})), { update: value });
        }
        return e;
    }, {});
